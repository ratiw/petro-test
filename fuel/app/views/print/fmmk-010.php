	...
	<div class="page_content">
		...
		<table style="width:100%">
			<tr>
				...
				<td>เลขที่ </td>
				<td class="data"><?php echo $mk_no; ?></td>
			</tr>
			<tr>
				<td style="width:25mm;">ชื่อลูกค้า</td>
				<td class="data"><?php echo $client; ?></td>
				<td style="width:25mm;">วันที่แจ้งผลิต</td>
				<td class="data"><?php echo $mk_date; ?></td>
			</tr>
			<tr>
				<td>P/O No.</td>
				<td class="data"><?php echo $client_po; ?></td>
				<td>กำหนดส่งมอบ</td>
				<td class="data"><?php echo $delivery_date; ?></td>
			</tr>
		</table>
			...
			<tr>
				<td>
					<table style="text-align:center;">
						...
						<tr class="belt_data">
							<td><?php echo $belt_type; ?></td>
							<td><?php echo $belt_color; ?></td>
							<td><?php echo $belt_width; ?></td>
							<td><?php echo $belt_ply; ?></td>
							<td><?php echo $belt_ep; ?></td>
							<td><?php echo $belt_thick; ?></td>
							<td><?php echo $belt_grade; ?></td>
						</tr>
					</table>
					<table style="text-align:center">
						<tr>
						...
						<tr class="belt_data">
							<td><?php echo $belt_length; ?></td>
							<td><?php echo $belt_end; ?></td>
							<td><?php echo $belt_qty; ?></td>
